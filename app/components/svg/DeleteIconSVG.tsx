const DeleteIconSVG = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="border-b-2 animation-transition hover:border-b-red-500 border-b-gray-100 dark:border-b-slate-700" width="24" height="24" viewBox="0 0 20 20" fill="none">
